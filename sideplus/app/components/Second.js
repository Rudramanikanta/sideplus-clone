    ...
    >
      ...
      <div className="grid grid-cols-2 px-10 lg:grid-cols-4 gap-x-4 ">
        {images.map((val, index) => (
          ...
          className="relative group block bg-center h-[380px] rounded-lg overflow-hidden item bg-no-repeat hover:bg-neutral-400"
        >
          <button
            className="absolute flex px-3 font-bold text-black transition-all duration-1000 ease-in transform bg-white opacity-0 group-hover:opacity-100 group-hover:translate-y-0 rounded-r-md bottom-10 -translate-y-1/4"
          >
